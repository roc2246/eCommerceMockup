...
function showAllData() {
  ...
  echo "<option value='$id'>$id $brand $model $size $price</option>";
...
function deleteRows() {
  ...
  if(isset($_POST['submit'])) {
    echo "Are you sure?";
    echo "<button name='yes' method='POST'>Yes</button>";
    echo "<button name='no' method='POST'>No</button>";

    if(isset($_POST['yes'])){
global $connection;
$id = $_POST['prodID'];
  
$query = "DELETE FROM inventory WHERE prodID = '$id' ";
